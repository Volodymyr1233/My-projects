...
bot = telebot.TeleBot("6416730921:AAHXygH1MndFzBUctJtFCnSIJr-el6BA7aE4")
...
""")
    ...
    bot.send_message(message.chat.id, str(message.from_user.first_name)+ ' ' + str(message.from_user.last_name) + ', виберіть будь ласка категорію анекдоту, яка Вас цікавить!', reply_markup=markup)
